...
public class RouteInfoBean implements Serializable
{
	...
	private boolean changeGps = false;//防止重复提交标识
	...
	public boolean isChangeGps() {
		return changeGps;
	}

	public void setChangeGps(boolean changeGps) {
		this.changeGps = changeGps;
	}

	public int getConfirmPointId() {
		return confirmPointId;
	}

	public void setConfirmPointId(int confirmPointId) {
		this.confirmPointId = confirmPointId;
	}
