...
public class GetTaskLineModel extends BaseViewModel {
    private boolean isRequesting = false;

    public GetTaskLineModel(Application application) {
        super(application);
    }
     ...
     * @param mRequest
     */
    public void getTaskLine(MallRequest mRequest,String uuid,int page) {
        ...
        String url = AllUrl.mainUrl + AllUrl.getTaskLine+"?taskUUID="+uuid+"&page="+page+"&rows=10";
        Log.d("qqqq","查询待办=="+url);
//        showProgressDialog(mContext,"正在加载数据...");
        mRequest.getTaskLine(map
                , url)
                ...
                .subscribe(new Observer<List<LXWaitListEntity>>() {
                    ...
                    public void onNext(List<LXWaitListEntity> roundSiteEntity) {
                        ...
                        if (!ToolUtil.isEmpty(roundSiteEntity)) {
