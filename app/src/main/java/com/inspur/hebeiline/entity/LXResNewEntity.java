...
public class LXResNewEntity implements Serializable{
    ...
    @Ignore
    private List<LinesNewBean> lines;
    ...
    public List<LinesNewBean> getLines() {
        return lines;
    }

    public void setLines(List<LinesNewBean> lines) {
        this.lines = lines;
    }
...
//            childColumns = "route_uuid")
    public static class LinesNewBean implements Serializable{
        /**
         * uuid : 392046951
